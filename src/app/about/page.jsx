    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <span className="inline-block px-4 py-1.5 mb-6 text-sm font-semibold tracking-wide text-green-700 uppercase bg-green-100 rounded-full dark:bg-green-900/30 dark:text-green-400">
              Transforming Education
            </span>
            <h1 className="text-5xl md:text-7xl font-extrabold text-foreground mb-8 tracking-tight">
              Democratizing <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-teal-500">Education</span> Through AI
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-foreground leading-tight">
              Our Story: Born from a Need for <span className="text-green-600">Personalization</span>
            </h2>
      ...
      <section className="py-24 bg-secondary/50 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Adaptive Engine", desc: "Our AI adjusts complexity in real-time based on your responses.", icon: Brain, color: "green" },
              { title: "Instant Feedback", desc: "Get detailed explanations and corrections within seconds.", icon: Zap, color: "teal" },
              { title: "Secure Learning", desc: "Your data is protected with enterprise-grade security.", icon: Shield, color: "emerald" }
            ].map((tech, i) => (
              <motion.div
                key={i}
                whileHover={{ y: -10 }}
              ...
              >
                <div className={`w-14 h-14 bg-white/40 dark:bg-white/10 border-2 border-white rounded-xl flex items-center justify-center mb-6 shadow-sm`}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="text-5xl font-extrabold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-teal-400">
                  {stat.value}
                </div>
                <div className="text-green-200 uppercase tracking-widest text-sm font-semibold">
                  {stat.label}
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">The principles that guide our journey</p>
        </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">The passionate experts behind the platform</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {team.map((member, index) => (
            <motion.div key={index} className="text-center group" variants={itemVariants}>
              <div className="relative mb-6 inline-block">
                <div className="absolute inset-0 bg-green-600 rounded-full scale-0 group-hover:scale-105 transition-transform duration-300 opacity-20" />
                <img
                  src={member.avatar}
                  alt={member.name}
              ...
              <p className="text-muted-foreground text-sm max-w-[250px] mx-auto">{member.bio}</p>
            </motion.div>
          ))}
        </div>
      </section>
