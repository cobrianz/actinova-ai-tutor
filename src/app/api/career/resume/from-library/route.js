...
Create a comprehensive, professional resume for a candidate who has completed a course titled "${role}".
${categoryLine} ${difficultyLine} ${descLine}
Candidate name: "${user.firstName || ""} ${user.lastName || ""}".
Email: "${user.email}".

The resume should highlight skills and projects most relevant to the "${role}" course content and the ${category || "technology"} domain.
