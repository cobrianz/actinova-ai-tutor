...
export default function LearnContent() {
  ...
  const [activeLesson, setActiveLesson] = useState({ moduleId: 1, lessonIndex: 0 })
  ...
  const [activeRightPanel, setActiveRightPanel] = useState("notes") // "notes" or "chat"
...
Your development environment is now ready!
  ...
  const getCurrentLesson = () => {
    ...
    if (typeof lesson === "string") {
      return { title: lesson, content: "Content for this lesson is coming soon..." }
    }
    return lesson
  }
    ...
    <div className="h-screen flex bg-gray-50 dark:bg-gray-900 overflow-hidden">
      ...
      <div className="w-80 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col">
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <h2 className="font-bold text-lg text-gray-900 dark:text-gray-100 mb-2">{courseData.title}</h2>
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            {courseData.totalModules} modules • {courseData.totalLessons} lessons
          </p>
            ...
            <div key={module.id} className="border-b border-gray-200 dark:border-gray-700 last:border-b-0">
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-gray-100 text-left">{module.title}</span>
                </div>
              ...
              {expandedModules.has(module.id) && (
                <div className="bg-gray-50 dark:bg-gray-700">
                  {module.lessons.map((lesson, lessonIndex) => {
                    ...
                    const isActive = activeLesson.moduleId === module.id && activeLesson.lessonIndex === lessonIndex
                    ...
                    return (
                      ...
                      >
                        ...
                        {!isCompleted && <Play className="w-4 h-4 text-gray-400" />}
                      </button>
                    )
                  })}
                </div>
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <span className="inline-block bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 px-2 py-1 rounded text-sm font-medium">
                {courseData.level}
              </span>
            </div>
            ...
            <div className="flex items-center space-x-2">
              <button
                onClick={() => toggleLessonCompletion(activeLesson.moduleId, activeLesson.lessonIndex)}
                ...
                <div
                  dangerouslySetInnerHTML={{
                    __html: currentLesson.content
                      .replace(
                        /^# (.*$)/gm,
                        '<h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6">$1</h1>',
                      )
                      .replace(
                        /^## (.*$)/gm,
                      ...
                      .replace(
                        /```(\w+)?\n([\s\S]*?)```/g,
                        '<pre class="bg-gray-100 dark:bg-gray-900 p-4 rounded-lg overflow-x-auto"><code class="text-sm">$2</code></pre>',
                      )
                      .replace(
                        /`([^`]+)`/g,
                      ...
                      .replace(/^(?!<[h|u|p|c])(.*$)/gm, '<p class="mb-4 text-gray-700 dark:text-gray-300">$1</p>'),
                  }}
                />
              </div>
            ) : (
          ...
          {activeRightPanel === "notes" ? (
            <div className="h-full flex flex-col">
              <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                <h3 className="font-semibold text-gray-900 dark:text-gray-100">My Notes</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">Take notes while learning</p>
              </div>
              ...
              <div className="p-4 border-t border-gray-200 dark:border-gray-700">
                <button
                  ...
                  disabled={!notes.trim()}
                  className="w-full flex items-center justify-center space-x-2 bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 disabled:opacity-50 transition-colors"
                >
            ...
            <div className="h-full flex flex-col">
              <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Ask questions about the lesson</p>
              </div>
      ...
      {/* Modals */}
      <NotesDownload notes={currentNotes} isOpen={showNotesDownload} onClose={() => setShowNotesDownload(false)} />
