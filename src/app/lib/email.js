...
const createTransporter = () => {
  ...
  // For production, consider using services like SendGrid, Mailgun, or Resend

  if (process.env.NODE_ENV === "development") {
    // Gmail SMTP configuration (you'll need to enable "Less secure app access" or use App Password)
    ...
    // Production configuration - you can switch to SendGrid, Mailgun, etc.
    return nodemailer.createTransport({
...
export async function sendVerificationEmail(
  ...
  try {
    ...
    const mailOptions = {
      from: `"Actinova AI Tutor" <${
        process.env.SMTP_USER || "noreply@actinova.com"
      }>`,
      to: email,
