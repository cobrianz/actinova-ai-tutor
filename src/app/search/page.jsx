...
export default function SearchPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-8">
      {/* Search Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Search Learning Resources</h1>
      ...
      {loading ? (
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{result.title}</h3>
                      <span
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 dark:text-gray-400">Enter a search term to find learning resources</p>
        </div>
      )}
    </div>
  )
