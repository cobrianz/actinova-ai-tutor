        ...
        <div className="w-full py-6 sm:py-10">
            ...
            <motion.header initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-10 text-center">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-green-500/10 border border-green-500/20 mb-5">
                    <Target size={26} className="text-green-600 dark:text-green-400" />
                </div>
                <h1 className="text-3xl font-black text-slate-900 dark:text-white" style={{ fontFamily: "var(--font-fraunces)" }}>Skill Gap Analysis</h1>
                <p className="text-slate-500 mt-2 text-sm">Bridge the gap between where you are and where you want to be</p>
            </motion.header>
            ...
            <div className="flex flex-col items-center gap-6">
                {!result ? (
                    /* Input Form */
                    <div className="w-full max-w-4xl bg-white dark:bg-slate-900 rounded-none md:rounded-3xl border-x-0 md:border border-slate-200 dark:border-slate-800 overflow-hidden">
                    ...
                    /* Results */
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-4xl space-y-6 pb-20">
                        {/* Score Card */}
