    ...
    if (!isStarted) return (
        <div className="w-full py-6 md:py-10">
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-10 text-center">
                ...
                <h1 className="text-3xl font-black text-slate-900 dark:text-white" style={{ fontFamily: "var(--font-fraunces)" }}>AI Mock Interview</h1>
                <p className="text-slate-500 mt-2 text-sm">Practice with AI-powered feedback tailored to your desired role</p>
            </motion.div>
