    ...
    return (
        <div className="w-full px-0 py-6 sm:py-10">
            ...
            <motion.header initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-10 text-center">
                ...
                <h1 className="text-3xl font-black text-slate-900 dark:text-white" style={{ fontFamily: "var(--font-fraunces)" }}>Network AI</h1>
                <p className="text-slate-500 mt-2 text-sm">Craft high-conversion outreach and discover the right mentors</p>
            </motion.header>
