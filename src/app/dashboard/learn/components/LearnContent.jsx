...
import CourseToolbar from "@/dashboard/learn/components/CourseToolbar";
import CourseSidebar from "@/dashboard/learn/components/CourseSidebar";
import LessonContentPanel from "@/dashboard/learn/components/LessonContentPanel";
    ...
    try {
      ...
      if (!isMyShareActive) { // Was not active, now is active
        toast.success("Sharing enabled!", {
          id: toastId,
          description: `Sharing is now active for this course.`,
          duration: 5000,
        });
      } else {
